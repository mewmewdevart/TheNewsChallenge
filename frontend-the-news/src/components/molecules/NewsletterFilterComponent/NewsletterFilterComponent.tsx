...
interface NewsletterFilterComponentProps {
...
const NewsletterFilterComponent: React.FC<NewsletterFilterComponentProps> = ({
  selectedNewsletter,
  onNewsletterChange,
  selectedPeriod,
  onPeriodChange,
...
export default NewsletterFilterComponent;
