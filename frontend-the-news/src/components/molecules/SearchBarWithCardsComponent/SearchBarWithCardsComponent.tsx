...
interface SearchBarWithCardsComponentProps {
  cardsData: CardData[];
}

const SearchBarWithCardsComponent: React.FC<SearchBarWithCardsComponentProps> = ({
  cardsData,
}) => {
...
export default SearchBarWithCardsComponent;