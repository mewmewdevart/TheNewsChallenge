...
const SearchBarWithCards: React.FC<SearchBarWithCardsProps> = ({
	...
	const handleCardKeyDown = (
		...
		card: { id: number; title: string; content: string }
	) => {
	...
	return (
		<div>
			...
			<div className="w-full grid grid-cols-2 md:grid-cols-3 gap-4 h-[325px]">
