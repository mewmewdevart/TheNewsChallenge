...
import ProgressBar from "../../molecules/StatsSkeleton/ProgressBar/ProgressBar";
...
const StatsGrid: React.FC<StatsGridProps> = ({ isLoading, streak }) => (
  <div className="bg-[--color-brand-neutral-100] grid grid-cols-4 gap-5 w-full mx-auto">
              ...
              .map((src, index) => (
                <div className="relative" key={index}>
                  <img
                    src={src}
                    alt={`Card ${index + 1}`}
                    className="w-[305px] h-[152px] object-cover cursor-pointer"
                  />
    ...
    <div className="col-span-1 border border-gray-100 h-[400px] ">
      {isLoading && (
